...
LOCAL_MODELS = {
    "lm_studio-qwen2.5-7b": "lm_studio/qwen2.5-7b-instruct",
...
# ONLINE_MODELS_desc = [
#     "gpt-4o-mini(pay&fast)",
# ]

# LOCAL_MODELS_desc = {
#     "qwen2.5-7b(free&slow)": "qwen2.5-7b-instruct",
# }

# MODELS_desc = ONLINE_MODELS_desc + list(LOCAL_MODELS_desc.keys())
MODELS = list(LOCAL_MODELS.keys()) + ONLINE_MODELS 
DEFAULT_MODEL = 0
